...
public class InPreset : CommandBlock
{
    ...
    public InPreset()
    {
        ...
        Cmd2 = (byte)PresetSelectControl.InPreset;
    }
    ...
    public InPreset(byte[] id)
    {
        ...
        Cmd1DataCount = ToCmd1DataCount(CommandFunction.PresetSelectControl, id.Length);
        Cmd2 = (byte)PresetSelectControl.InPreset;
        Data = id;
    }
    ...
    public InPreset(TimeCode tc, byte[] id)
    {
        ...
        Cmd1DataCount = ToCmd1DataCount(CommandFunction.PresetSelectControl, buffer.Length);
        Cmd2 = (byte)PresetSelectControl.InPreset;
        Data = buffer;
    }
